...
@Component({
  selector: 'air-antd-table-transactionstatustable',
  templateUrl: './transactionstatustable.component.html',
  styles: [
    `
      .table-operations {
        margin-bottom: 16px;
...
export class TransactionstatusTableComponent implements OnInit {
