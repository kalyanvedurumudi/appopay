...
@Component({
  selector: 'app-statusactivationcard',
  templateUrl: './statusactivationcard.component.html',
   styleUrls: ['./statusactivationcard.component.scss'],
  styles: [
    `
...
export class StatusActivationcardComponent implements OnInit {
