...
@Component({
  selector: 'app-completeenrollment',
  templateUrl: './completeenrollment.component.html',
   styleUrls: ['./completeenrollment.component.scss'],
  styles: [
    `
...
export class CompleteEnrollmentComponent implements OnInit {
