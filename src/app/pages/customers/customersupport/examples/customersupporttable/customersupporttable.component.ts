...
@Component({
  selector: 'air-antd-table-customersupporttable',
  templateUrl: './customersupporttable.component.html',
  styles: [
    `
      .table-operations {
        margin-bottom: 16px;
...
export class CustomersupportTableComponent implements OnInit {
